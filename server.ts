...
// ============================================================
// PRODUCTION PORT BINDING — FIXES RAILWAY 502 ERROR
// ============================================================
const PORT = process.env.PORT || 3000;

// ============================================================
// PERSISTENT DATABASE PATH — WORKS WITH RAILWAY VOLUMES
// ============================================================
// If you attach a volume at /data, it will persist across restarts.
// Otherwise, it falls back to the current working directory.
const DB_PATH = process.env.DB_PATH || "/data/db.json";
const DB_FILE = fs.existsSync(path.dirname(DB_PATH))
  ? DB_PATH
  : path.join(process.cwd(), "db.json");

// ============================================================
// SYSTEM-WIDE PSEUDONYMS FOR BLACK ROOM
// ============================================================
const pseudonyms = [
...
// ============================================================
// DATABASE LOADER WITH SCHEMA HOT-PATCHES
// ============================================================
function getDB() {
  let db: any;
  ...
  // ============================================================
  // SCHEMA HOT-PATCHES — KEEP EVERYTHING COMPATIBLE
  // ============================================================
  let updated = false;

  // Ensure admin has 1,000,000 points and elite tier
  ...
  // Ensure demo user has professional tier
  ...
  // Ensure receipt_price_points is 150
    ...
    db.templates = [
      {
        ...
        name: "Signia Premium Gold Voucher",
        category: "voucher",
        html_content: `<!-- full template content -->`,
        created_at: new Date().toISOString()
      },
      {
        id: "tmpl-emerald-receipt",
