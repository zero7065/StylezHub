      ...
      >
        ...
        <div className="space-y-2">
          ...
          <a
            ...
            className="flex items-center justify-between p-2 rounded-xl bg-slate-900 border border-slate-855 hover:border-[#00E5FF]/40 text-xs text-slate-200 hover:text-white transition-all"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-between p-2 rounded-xl bg-slate-900 border border-slate-855 hover:border-green-500/40 text-xs text-slate-200 hover:text-white transition-all"
          >
            <span className="flex items-center gap-2">
          ...
          <a
            ...
            className="flex items-center justify-between p-2 rounded-xl bg-slate-900 border border-slate-855 hover:border-indigo-500/40 text-xs text-slate-200 hover:text-white transition-all"
          >
            <span className="flex items-center gap-2">
        ...
        <div className="text-[9px] font-mono text-gray-500 text-center mt-3 border-t border-slate-850/60 pt-2 leading-relaxed">
