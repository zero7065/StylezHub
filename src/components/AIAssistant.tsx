    ...
    <div className="fixed bottom-6 right-6 z-50 font-sans">
      ...
      {isOpen ? (
        <div className="w-[360px] max-h-[500px] h-[480px] rounded-3xl border border-slate-800 bg-[#0B0E14]/95 text-white shadow-2xl flex flex-col backdrop-blur-md overflow-hidden animate-in fade-in slide-in-from-bottom-5">
          ...
          <div className="px-4 py-1.5 bg-slate-950/40 border-t border-slate-850 flex gap-1.5 overflow-x-auto text-[9px] text-cyan-400 font-mono scrollbar-none">
            <button
          ...
          {/* Form Input Submit */}
          <form onSubmit={handleSendMessage} className="p-3 border-t border-slate-850/80 bg-slate-950 flex gap-2">
            <input
              type="text"
